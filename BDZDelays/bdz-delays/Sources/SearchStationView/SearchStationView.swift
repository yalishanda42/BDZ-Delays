            ...
            if vs.locationStatus != .unableToUseLocation
                ...
                Section {
                    ...
                    if vs.locationStatus == .denied {
                        Text("За да се определи коя е най-близката ЖП гара, трябва да се разреши достъп до местоположението в настройките на приложенето (натиснете горния бутон, за да ви отведе там)")}
                }
            }
